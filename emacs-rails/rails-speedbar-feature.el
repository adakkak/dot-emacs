(defvar rails-speedbar:roots
  '(("Controllers"                 rails-core:controllers       rails-core:controller-file)
    ...
    ("Functional Controller Tests" rails-core:functional-controller-tests  rails-core:functional-controller-test-file)
    ("Functional Model Tests"      rails-core:functional-model-tests  rails-core:functional-model-test-file)
