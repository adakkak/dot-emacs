...
(defconst rails-minor-mode-nav-menu-bar-map
  (let ((map (make-sparse-keymap)))
    (define-keys map
      ...
      ([goto-unit-model-tests]       '("Go to Unit Model Tests"       . rails-nav:goto-unit-model-tests))
      ([goto-unit-controller-tests]  '("Go to Unit Controller Tests"       . rails-nav:goto-unit-controller-tests))
      ([goto-func-tests]             '("Go to Functional Tests" . rails-nav:goto-functional-tests))
      ([goto-func-controller-tests]  '("Go to Functional Controller Tests" . rails-nav:goto-functional-controller-tests))
      ([goto-func-model-tests]       '("Go to Functional Model Tests" . rails-nav:goto-functional-model-tests))
...
(define-keys rails-minor-mode-map
  ...
  ((rails-key "\C-c f m") 'rails-nav:goto-functional-model-tests)
  ((rails-key "\C-c f c") 'rails-nav:goto-functional-controller-tests)
  ((rails-key "\C-c g u") 'rails-nav:goto-unit-tests)
  ((rails-key "\C-c u m") 'rails-nav:goto-unit-model-tests)
  ((rails-key "\C-c u c") 'rails-nav:goto-unit-controller-tests)
